...
public class PostRepository : IPostRepository
{
    ...
    public async Task DaleteAsync(long id)
    {
    ...
    public async Task<IEnumerable<Post>> GetAllPostsAsync(Expression<Func<Post, bool>> exp) => await _context.Posts.Where(exp).ToListAsync();
